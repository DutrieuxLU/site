...
const Hero = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-top py-12 lg:py-10 lg:h-screen bg-amber-100 gap-y-4">
      ...
      <Draggable disabled={!draggable}>
        <div className="w-10/12 mx-auto sm:w-1/2">
          <div className="p-4 bg-white border-4 border-black rounded-sm shadow-blocks shadow-gray-800 justp">
